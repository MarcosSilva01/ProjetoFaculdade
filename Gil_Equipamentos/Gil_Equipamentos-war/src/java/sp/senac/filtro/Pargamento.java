 ...
 * @author Heitor
 */
@WebFilter(filterName = "Pagamento", urlPatterns = {"/Pagamento.xhtml"})
public class Pargamento implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(usuario == null || usuario.getTipo().equalsIgnoreCase("Funcionario")){
